                ...
                <div class="row">
                    <div class="col">
                        <div class="widget-about font-md mb-md-3 mb-lg-3 mb-xl-0 wow animate__animated animate__fadeInUp" data-wow-delay="0">
                            <div class="logo mb-30">
                                <a href="{{ asset('index.html') }}" class="mb-15"><img src="{{ asset('frontend/imgs/theme/logo.svg') }}" alt="logo" /></a>
                    ...
                    <div class="footer-link-widget col wow animate__animated animate__fadeInUp" data-wow-delay=".1s>
                        ...
                        <ul class="footer-list mb-sm-5 mb-md-0">
                            ...
                            <li><a href="{{ asset('#') }}">Delivery Information</a></li>
                            <li><a href="{{ asset('#') }}">Privacy Policy</a></li>
                            <li><a href="{{ asset('#') }}">Terms &amp; Conditions</a></li>
                    ...
                    <div class="footer-link-widget col wow animate__animated animate__fadeInUp" data-wow-delay=".2s">
                        ...
                        <ul class="footer-list mb-sm-5 mb-md-0">
                            ...
                            <li><a href="{{ asset('#') }}">View Cart</a></li>
                            <li><a href="{{ asset('#') }}">My Wishlist</a></li>
                            <li><a href="{{ asset('#') }}">Track My Order</a></li>
                            <li><a href="{{ asset('#') }}">Help Ticket</a></li>
                            <li><a href="{{ asset('#') }}">Shipping Details</a></li>
                            <li><a href="{{ asset('#') }}">Compare products</a></li>
                        </ul>
                    </div>
                    <div class="footer-link-widget col wow animate__animated animate__fadeInUp" data-wow-delay=".3s">
                        <h4 class="widget-title">Corporate</h4>
                        <ul class="footer-list mb-sm-5 mb-md-0">
                            <li><a href="{{ asset('#') }}">Become a Vendor</a></li>
                            <li><a href="{{ asset('#') }}">Affiliate Program</a></li>
                            <li><a href="{{ asset('#') }}">Farm Business</a></li>
                            <li><a href="{{ asset('#') }}">Farm Careers</a></li>
                            <li><a href="{{ asset('#') }}">Our Suppliers</a></li>
                            <li><a href="{{ asset('#') }}">Accessibility</a></li>
                    ...
                    <div class="footer-link-widget col wow animate__animated animate__fadeInUp" data-wow-delay=".4s">
                        ...
                        <ul class="footer-list mb-sm-5 mb-md-0">
                            <li><a href="{{ asset('#') }}">Milk & Flavoured Milk</a></li>
                            <li><a href="{{ asset('#') }}">Butter and Margarine</a></li>
                            <li><a href="{{ asset('#') }}">Eggs Substitutes</a></li>
                            <li><a href="{{ asset('#') }}">Marmalades</a></li>
                            <li><a href="{{ asset('#') }}">Sour Cream and Dips</a></li>
                            <li><a href="{{ asset('#') }}">Tea & Kombucha</a></li>
                            <li><a href="{{ asset('#') }}">Cheese</a></li>
                        </ul>
                    </div>
