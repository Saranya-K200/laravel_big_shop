                                        ...
                                        <ul>
                                            <li>
                                                ...
                                                <div class="shopping-cart-title">
                                                    <h4><a href="{{ asset('shop-product-right.html') }}">Daisy Casual Bag</a></h4>
                                            ...
                                            <li>
                                                <div class="shopping-cart-img">
                                                    <a href="{{ asset('shop-product-right.html') }}"><img alt="Nest" src="{{ asset('frontend/imgs/shop/thumbnail-2.jpg') }}" /></a>
                                                </div>
                                                <div class="shopping-cart-title">
                                                    <h4><a href="{{ asset('shop-product-right.html') }}">Corduroy Shirts</a></h4>
