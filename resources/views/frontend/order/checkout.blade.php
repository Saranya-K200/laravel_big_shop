            ...
            <div class="col-lg-5">
                        ...
                        <table class="table no-border">
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <h6 class="w-160 mb-5"><a href="shop-product-full.html" class="text-heading">{{ $row->product->name }}</a></h6></span>
                                        <div class="product-rate-cover">
                                            <div class="product-rate d-inline-block">
                                                <div class="product-rating" style="width:90%">
                                                </div>
                                            </div>
                                            <span class="font-small ml-5 text-muted"> {{ $row->product->qty }}</span>
                                        </div>
                                    </td>
                                    <td>
                ...
                <div class="payment ml-30">
                    ...
                    <div class="payment-logo d-flex">
                        <img class="mr-15" src="frontend/imgs/theme/icons/payment-paypal.svg" alt="">
                        <img class="mr-15" src="frontend/imgs/theme/icons/payment-visa.svg" alt="">
                        <img class="mr-15" src="frontend/imgs/theme/icons/payment-master.svg" alt="">
