                    ...
                    <div class="row">
                                        ...
                                        <div class="detail-info pr-30 pl-30">
                                            ...
                                            <div class="font-xs">
                                                ...
                                                <ul class="float-start">
                                                    <li class="mb-5">SKU: <a href="{{ asset('#') }}">FWM15VKT</a></li>
                                            ...
                                            <div class="tab-pane fade" id="Vendor-info">
                                                <div class="vendor-logo d-flex mb-30">
                                                    ...
                                                    <div class="vendor-name ml-15">
                                                        <h6>
                                                            <a href="{{ asset('vendor-details-2.html') }}">Noodles Co.</a>
                                                        </h6>
                                                        <div class="product-rate-cover text-end">
                                                            <div class="product-rate d-inline-block">
                                                                <div class="product-rating" style="width: 90%"></div>
                        ...
                        <div class="col-xl-3 primary-sidebar sticky-sidebar mt-30">
                            <div class="sidebar-widget widget-category-2 mb-30">
                                ...
                                <ul>
                                    <li>
                                        <a href="{{ asset('shop-grid-right.html') }}"> <img src="{{ asset('frontend/imgs/theme/icons/category-1.svg') }}" alt="" />Milks & Dairies</a><span class="count">30</span>
                                    </li>
                                    <li>
                                        <a href="{{ asset('shop-grid-right.html') }}"> <img src="{{ asset('frontend/imgs/theme/icons/category-2.svg') }}" alt="" />Clothing</a><span class="count">35</span>
                                    </li>
                                    <li>
                                        <a href="{{ asset('shop-grid-right.html') }}"> <img src="{{ asset('frontend/imgs/theme/icons/category-3.svg') }}" alt="" />Pet Foods </a><span class="count">42</span>
                                    </li>
                                    <li>
                                        <a href="{{ asset('shop-grid-right.html') }}"> <img src="{{ asset('frontend/imgs/theme/icons/category-4.svg') }}" alt="" />Baking material</a><span class="count">68</span>
                                    </li>
                                    <li>
                                        <a href="{{ asset('shop-grid-right.html') }}"> <img src="{{ asset('frontend/imgs/theme/icons/category-5.svg') }}" alt="" />Fresh Fruit</a><span class="count">87</span>
                                    </li>
                                </ul>
                            </div>
                            <!-- Fillter By Price -->
                            <div class="sidebar-widget price_range range mb-30">
                                ...
                                <a href="{{ asset('shop-grid-right.html') }}" class="btn btn-sm btn-default"><i class="fi-rs-filter mr-5"></i> Fillter</a>
                            </div>
