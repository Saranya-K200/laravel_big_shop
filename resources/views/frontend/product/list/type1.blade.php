                        ...
                        <div class="product-cart-wrap mb-30">
                            <div class="product-img-action-wrap">
                                ...
                                <div class="product-badges product-badges-position product-badges-mrg">
                                    ...
                                    @foreach($row->productLabel()->pluck('name') as $label)
                                        @if($label == 'Hot')
                                        ...
                                        @elseif($label == 'Red')
                                            <!-- Apply red color class if the label is 'Red' -->
                            ...
                            <div class="product-content-wrap">
                                ...
                                <div>
                                    <span class="font-small text-muted">By <a href="vendor-details-1.html">{{ $row->productCompany()->pluck('name')->implode(',') }}</a></span>
                                </div>
